    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-4 gap-12 border-b border-gray-800 pb-12 mb-12">
      ...
      <div>
        ...
        <ul className="space-y-4 text-gray-400 text-sm">
          ...
          <li><button onClick={() => setPage('faq')} className="hover:text-white text-left">FAQ & Support</button></li>
          <li><button onClick={() => setPage('blog')} className="hover:text-white text-left">Latest Blog</button></li>
          <li><button onClick={() => setPage('privacy-policy')} className="hover:text-white text-left">Privacy Policy</button></li>
          <li><button onClick={() => setPage('terms-of-service')} className="hover:text-white text-left">Terms of Service</button></li>
          <li><button onClick={() => setPage('cookie-policy')} className="hover:text-white text-left">Cookie Policy</button></li>
        </ul>
      </div>
